...
function Library:CreateWindow(WindowInfo)
    ...
    local bgv = New("VideoFrame", {
    Size = UDim2.fromScale(1, 1),
    BackgroundTransparency = 1,
    Video = "https://raw.githubusercontent.com/Potato5466794/LUAUmisc/refs/heads/main/Video_1770894406219_889.mp4",
    Looped = true,
    Volume = 0,
    ZIndex = 0,
    Parent = MainFrame,
    ...
    Parent = bgv,
        ...
        local tpl = Library:MakeLine(MainFrame, {
    Position = UDim2.fromOffset(0, 48),
    Size = UDim2.new(1, 0, 0, 1),
})
tpl.BackgroundTransparency = 0.76
